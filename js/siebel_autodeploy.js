...
var sebl_conf = {
    ...
    fields: {
        ...
        mig_sid: {
            value: "orcl.company.com", label: "Migration App Database Service Name", group: "Migration Application", seq: 2,
...
sebl_setmigprof = function () {
    ...
    //20.10 or higher: database access via REST
    if (is2010) {
        data = JSON.stringify(
            {
                "MigrationConfigParams": {
                    "SiebelRESTEndpoint": "https://" + sebl_conf.fields.ai_host.value + ":" + sebl_conf.fields.ai_port.value + "/siebel/v1.0",
                    "AuthenticationType": "Basic",
                    "LogLevel": "Error",
                    "Timeout": 3000,
                    "SleepTime": 15,
